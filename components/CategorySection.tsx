...
export function CategorySection({ title, href, videoSrc, imageSrc, index }: Props) {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden group" style={{ height: '100vh' }}>
      ...
      >
        ...
        <div className="flex items-end justify-between gap-6 flex-wrap">
          ...
          >
            <Link
              href={href}
              className="group/btn flex items-center gap-3 text-white transition-colors duration-300 hover:text-[#C7E200]"
              style={{ fontSize: '0.8rem', letterSpacing: '0.18em', fontWeight: 500, textTransform: 'uppercase' }}
            >
              View Work
              <span
                className="flex items-center justify-center transition-all duration-300 group-hover/btn:bg-[#C7E200] group-hover/btn:text-black"
                style={{
                  width: 36, height: 36,
